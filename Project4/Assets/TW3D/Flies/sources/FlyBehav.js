...
var displacement:Vector3 = Vector3(100,20,100);
...
function UpdateDespl() {
	...
	var x:float = (Mathf.PerlinNoise(Time.time*desplVel +iniRndX, iniRndX) -0.46525) *5*displacement.x;
	var y:float = (Mathf.PerlinNoise(iniRndY, iniRndY+ Time.time*desplVel) -0.46525) *5*displacement.y;
	var z:float = (Mathf.PerlinNoise(iniRndZ, iniRndZ+ Time.time*desplVel) -0.46525) *5*displacement.z;
